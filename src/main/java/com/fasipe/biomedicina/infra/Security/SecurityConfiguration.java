    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception{
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "agenda/byVisita/{visita}").permitAll()
                        .requestMatchers(HttpMethod.GET, "agenda/byLoginAndVisita").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/agenda/{id}/visita").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/resultadoexame/byUserLogin/{login}").permitAll()
